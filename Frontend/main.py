...
st.set_page_config(
    page_title="Neural Network Analysis of Brain Tumor",
    page_icon="🏥"
)
...
st.header("Neural Network Analysis of Brain Tumor")
...
img1 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\GitHub Upload\Brain Tumor\Image Formats\no0.jpg")
img2 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\GitHub Upload\Brain Tumor\Image Formats\no2.jpg")
img3 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\GitHub Upload\Brain Tumor\Image Formats\no69.jpg")
...
try:
    ...
    photo = st.file_uploader("Upload C.T.Scanned Image of Brain", type=['png', 'jpeg', 'jpg'])
    st.image(photo)

    if photo is not None:
        if st.button('Predict'):
            model = load_model('brain_tumour_CNN.h5')
            ...
            if pred[0] >= 0.5:
                st.header("**the input image consists Brain Tumour**")
            else:
                st.header("**the input image does not contain Brain Tumour**")
